<?php
class api10_FacebookApi10_auth_getSession_result {
  public $success = null;
  ...
  public function getName() {
    return 'FacebookApi10_auth_getSession_result';
  }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new api10_session_info();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('FacebookApi10_auth_getSession_result');
