<?php
class api10_FacebookApi10_admin_setAppProperties_result {
  public $success = null;
  ...
  public function getName() {
    return 'FacebookApi10_admin_setAppProperties_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('FacebookApi10_admin_setAppProperties_result');
