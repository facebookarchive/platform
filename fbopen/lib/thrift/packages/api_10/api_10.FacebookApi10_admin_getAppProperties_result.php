<?php
class api10_FacebookApi10_admin_getAppProperties_result {
  public $success = null;
  ...
  public function getName() {
    return 'FacebookApi10_admin_getAppProperties_result';
  }
        ...
        case 0:
          if ($ftype == TType::STRING) {
            if (($input instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_binary_deserialize')) {
              $this->success = thrift_protocol_binary_deserialize(TType::STRING, $input);
            } else {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('FacebookApi10_admin_getAppProperties_result');
