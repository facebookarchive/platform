<?php
class api10_FacebookApi10_feed_publishActionOfUser_result {
  public $success = null;
  ...
  public function getName() {
    return 'FacebookApi10_feed_publishActionOfUser_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('FacebookApi10_feed_publishActionOfUser_result');
