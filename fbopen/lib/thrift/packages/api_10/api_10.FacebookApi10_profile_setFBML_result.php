<?php
class api10_FacebookApi10_profile_setFBML_result {
  public $success = null;
  ...
  public function getName() {
    return 'FacebookApi10_profile_setFBML_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('FacebookApi10_profile_setFBML_result');
