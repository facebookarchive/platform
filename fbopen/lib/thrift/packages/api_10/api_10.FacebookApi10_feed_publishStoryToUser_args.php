<?php
class api10_FacebookApi10_feed_publishStoryToUser_args {
  public $title = null;
  public $body = null;
  public $image_1 = null;
  ...
  public function getName() {
    return 'FacebookApi10_feed_publishStoryToUser_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('FacebookApi10_feed_publishStoryToUser_args');
    if ($this->title !== null) {
