...
public:
  ...
  void ToString(nsAString& aString, nsICSSStyleSheet* aSheet,
                const nsString& aIdPrefix, PRBool aAppend = PR_FALSE) const;
...
private:
  ...
  void ToStringInternal(nsAString& aString, nsICSSStyleSheet* aSheet,
                        ...
                        PRIntn aNegatedIndex, const nsString& aIdPrefix) const;
...
struct nsCSSSelectorList {
  ...
  virtual ~nsCSSSelectorList(void);
   ...
   */
  virtual void ToString(nsAString& aResult, nsICSSStyleSheet* aSheet);
