...
#define CSS_PROP_FILTER(name_, id_, method_, datastruct_, member_, type_, kwtable_) CSS_PROP(name_, id_, method_, datastruct_, member_, type_, kwtable_)
...
#endif
#ifndef CSS_PROP_FILTER
#define CSS_PROP_FILTER(name_, id_, method_, datastruct_, member_, type_, kwtable_) /* nothing */
#define DEFINED_CSS_PROP_FILTER
#endif
...
CSS_PROP_FILTER(filter, filter, Filter, Filter, mValue, eCSSType_Value, nsnull)
...
#endif
#ifdef DEFINED_CSS_PROP_FILTER
#undef CSS_PROP_FILTER
#undef DEFINED_CSS_PROP_FILTER
#endif
