...
class NS_NO_VTABLE nsICharsetConverterManager : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetCharsetAlias(const char *charset, nsACString & _retval) = 0;
  ...
  NS_IMETHOD GetCharsetTitle(const char *charset, nsAString & _retval) = 0;
  ...
  NS_IMETHOD GetCharsetData(const char *charset, const PRUnichar *prop, nsAString & _retval) = 0;
  ...
  NS_IMETHOD GetCharsetLangGroup(const char *charset, nsIAtom **_retval) = 0;

  /* nsIAtom getCharsetLangGroupRaw (in string charset); */
  NS_IMETHOD GetCharsetLangGroupRaw(const char *charset, nsIAtom **_retval) = 0;
...
#define NS_DECL_NSICHARSETCONVERTERMANAGER \
  ...
  NS_IMETHOD GetCharsetAlias(const char *charset, nsACString & _retval); \
  ...
  NS_IMETHOD GetCharsetTitle(const char *charset, nsAString & _retval); \
  NS_IMETHOD GetCharsetData(const char *charset, const PRUnichar *prop, nsAString & _retval); \
  NS_IMETHOD GetCharsetLangGroup(const char *charset, nsIAtom **_retval); \
  NS_IMETHOD GetCharsetLangGroupRaw(const char *charset, nsIAtom **_retval); 
...
#define NS_FORWARD_NSICHARSETCONVERTERMANAGER(_to) \
  ...
  NS_IMETHOD GetCharsetAlias(const char *charset, nsACString & _retval) { return _to GetCharsetAlias(charset, _retval); } \
  ...
  NS_IMETHOD GetCharsetTitle(const char *charset, nsAString & _retval) { return _to GetCharsetTitle(charset, _retval); } \
  NS_IMETHOD GetCharsetData(const char *charset, const PRUnichar *prop, nsAString & _retval) { return _to GetCharsetData(charset, prop, _retval); } \
  NS_IMETHOD GetCharsetLangGroup(const char *charset, nsIAtom **_retval) { return _to GetCharsetLangGroup(charset, _retval); } \
  NS_IMETHOD GetCharsetLangGroupRaw(const char *charset, nsIAtom **_retval) { return _to GetCharsetLangGroupRaw(charset, _retval); } 
...
#define NS_FORWARD_SAFE_NSICHARSETCONVERTERMANAGER(_to) \
  ...
  NS_IMETHOD GetCharsetAlias(const char *charset, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharsetAlias(charset, _retval); } \
  ...
  NS_IMETHOD GetCharsetTitle(const char *charset, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharsetTitle(charset, _retval); } \
  NS_IMETHOD GetCharsetData(const char *charset, const PRUnichar *prop, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharsetData(charset, prop, _retval); } \
  NS_IMETHOD GetCharsetLangGroup(const char *charset, nsIAtom **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharsetLangGroup(charset, _retval); } \
  NS_IMETHOD GetCharsetLangGroupRaw(const char *charset, nsIAtom **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharsetLangGroupRaw(charset, _retval); } 
