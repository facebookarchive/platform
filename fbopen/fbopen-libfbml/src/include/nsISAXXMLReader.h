...
class NS_NO_VTABLE nsISAXXMLReader : public nsIStreamListener {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISAXXMLREADER_IID)
  ...
  NS_IMETHOD SetFeature(const nsAString & name, PRBool value) = 0;
  ...
  NS_IMETHOD GetFeature(const nsAString & name, PRBool *_retval) = 0;
  ...
  NS_IMETHOD GetProperty(const nsAString & name, PRBool *_retval) = 0;
...
#define NS_DECL_NSISAXXMLREADER \
  ...
  NS_IMETHOD SetFeature(const nsAString & name, PRBool value); \
  NS_IMETHOD GetFeature(const nsAString & name, PRBool *_retval); \
  NS_IMETHOD SetProperty(const nsAString & name, nsISupports *value); \
  NS_IMETHOD GetProperty(const nsAString & name, PRBool *_retval); \
...
#define NS_FORWARD_NSISAXXMLREADER(_to) \
  ...
  NS_IMETHOD SetFeature(const nsAString & name, PRBool value) { return _to SetFeature(name, value); } \
  NS_IMETHOD GetFeature(const nsAString & name, PRBool *_retval) { return _to GetFeature(name, _retval); } \
  NS_IMETHOD SetProperty(const nsAString & name, nsISupports *value) { return _to SetProperty(name, value); } \
  NS_IMETHOD GetProperty(const nsAString & name, PRBool *_retval) { return _to GetProperty(name, _retval); } \
...
#define NS_FORWARD_SAFE_NSISAXXMLREADER(_to) \
  ...
  NS_IMETHOD SetFeature(const nsAString & name, PRBool value) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetFeature(name, value); } \
  NS_IMETHOD GetFeature(const nsAString & name, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFeature(name, _retval); } \
  ...
  NS_IMETHOD GetProperty(const nsAString & name, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetProperty(name, _retval); } \
