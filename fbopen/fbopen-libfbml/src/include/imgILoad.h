 ...
 * @see imagelib2
 */
class NS_NO_VTABLE imgILoad : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(IMGILOAD_IID)
  ...
  NS_IMETHOD GetIsMultiPartChannel(PRBool *aIsMultiPartChannel) = 0;
...
#define NS_DECL_IMGILOAD \
  ...
  NS_IMETHOD GetIsMultiPartChannel(PRBool *aIsMultiPartChannel); 
...
#define NS_FORWARD_IMGILOAD(_to) \
  ...
  NS_IMETHOD GetIsMultiPartChannel(PRBool *aIsMultiPartChannel) { return _to GetIsMultiPartChannel(aIsMultiPartChannel); } 
...
#define NS_FORWARD_SAFE_IMGILOAD(_to) \
  ...
  NS_IMETHOD GetIsMultiPartChannel(PRBool *aIsMultiPartChannel) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsMultiPartChannel(aIsMultiPartChannel); } 
