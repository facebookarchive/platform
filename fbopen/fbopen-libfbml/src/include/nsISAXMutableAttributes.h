...
class NS_NO_VTABLE nsISAXMutableAttributes : public nsISAXAttributes {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISAXMUTABLEATTRIBUTES_IID)
  ...
  NS_IMETHOD RemoveAttribute(PRUint32 index) = 0;
  ...
  NS_IMETHOD SetAttribute(PRUint32 index, const nsAString & uri, const nsAString & localName, const nsAString & qName, const nsAString & type, const nsAString & value) = 0;
  ...
  NS_IMETHOD SetLocalName(PRUint32 index, const nsAString & localName) = 0;
  ...
  NS_IMETHOD SetQName(PRUint32 index, const nsAString & qName) = 0;
  ...
  NS_IMETHOD SetType(PRUint32 index, const nsAString & type) = 0;
  ...
  NS_IMETHOD SetURI(PRUint32 index, const nsAString & uri) = 0;
  ...
  NS_IMETHOD SetValue(PRUint32 index, const nsAString & value) = 0;
...
#define NS_DECL_NSISAXMUTABLEATTRIBUTES \
  ...
  NS_IMETHOD RemoveAttribute(PRUint32 index); \
  NS_IMETHOD SetAttributes(nsISAXAttributes *attributes); \
  NS_IMETHOD SetAttribute(PRUint32 index, const nsAString & uri, const nsAString & localName, const nsAString & qName, const nsAString & type, const nsAString & value); \
  NS_IMETHOD SetLocalName(PRUint32 index, const nsAString & localName); \
  NS_IMETHOD SetQName(PRUint32 index, const nsAString & qName); \
  NS_IMETHOD SetType(PRUint32 index, const nsAString & type); \
  NS_IMETHOD SetURI(PRUint32 index, const nsAString & uri); \
  NS_IMETHOD SetValue(PRUint32 index, const nsAString & value); 
...
#define NS_FORWARD_NSISAXMUTABLEATTRIBUTES(_to) \
  ...
  NS_IMETHOD RemoveAttribute(PRUint32 index) { return _to RemoveAttribute(index); } \
  NS_IMETHOD SetAttributes(nsISAXAttributes *attributes) { return _to SetAttributes(attributes); } \
  NS_IMETHOD SetAttribute(PRUint32 index, const nsAString & uri, const nsAString & localName, const nsAString & qName, const nsAString & type, const nsAString & value) { return _to SetAttribute(index, uri, localName, qName, type, value); } \
  NS_IMETHOD SetLocalName(PRUint32 index, const nsAString & localName) { return _to SetLocalName(index, localName); } \
  NS_IMETHOD SetQName(PRUint32 index, const nsAString & qName) { return _to SetQName(index, qName); } \
  NS_IMETHOD SetType(PRUint32 index, const nsAString & type) { return _to SetType(index, type); } \
  NS_IMETHOD SetURI(PRUint32 index, const nsAString & uri) { return _to SetURI(index, uri); } \
  NS_IMETHOD SetValue(PRUint32 index, const nsAString & value) { return _to SetValue(index, value); } 
...
#define NS_FORWARD_SAFE_NSISAXMUTABLEATTRIBUTES(_to) \
  ...
  NS_IMETHOD RemoveAttribute(PRUint32 index) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveAttribute(index); } \
  NS_IMETHOD SetAttributes(nsISAXAttributes *attributes) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAttributes(attributes); } \
  NS_IMETHOD SetAttribute(PRUint32 index, const nsAString & uri, const nsAString & localName, const nsAString & qName, const nsAString & type, const nsAString & value) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAttribute(index, uri, localName, qName, type, value); } \
  NS_IMETHOD SetLocalName(PRUint32 index, const nsAString & localName) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetLocalName(index, localName); } \
  NS_IMETHOD SetQName(PRUint32 index, const nsAString & qName) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetQName(index, qName); } \
  NS_IMETHOD SetType(PRUint32 index, const nsAString & type) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetType(index, type); } \
  NS_IMETHOD SetURI(PRUint32 index, const nsAString & uri) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetURI(index, uri); } \
  NS_IMETHOD SetValue(PRUint32 index, const nsAString & value) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetValue(index, value); } 
