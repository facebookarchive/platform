...
class NS_NO_VTABLE nsISAXAttributes : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISAXATTRIBUTES_IID)
  ...
  NS_IMETHOD GetIndexFromName(const nsAString & uri, const nsAString & localName, PRInt32 *_retval) = 0;
  ...
  NS_IMETHOD GetIndexFromQName(const nsAString & qName, PRInt32 *_retval) = 0;
  ...
  NS_IMETHOD GetLocalName(PRUint32 index, nsAString & _retval) = 0;
  ...
  NS_IMETHOD GetQName(PRUint32 index, nsAString & _retval) = 0;
  ...
  NS_IMETHOD GetType(PRUint32 index, nsAString & _retval) = 0;
  ...
  NS_IMETHOD GetURI(PRUint32 index, nsAString & _retval) = 0;
  ...
  NS_IMETHOD GetValue(PRUint32 index, nsAString & _retval) = 0;
...
#define NS_DECL_NSISAXATTRIBUTES \
  NS_IMETHOD GetIndexFromName(const nsAString & uri, const nsAString & localName, PRInt32 *_retval); \
  NS_IMETHOD GetIndexFromQName(const nsAString & qName, PRInt32 *_retval); \
  NS_IMETHOD GetLength(PRInt32 *aLength); \
  NS_IMETHOD GetLocalName(PRUint32 index, nsAString & _retval); \
  NS_IMETHOD GetQName(PRUint32 index, nsAString & _retval); \
  NS_IMETHOD GetType(PRUint32 index, nsAString & _retval); \
  ...
  NS_IMETHOD GetURI(PRUint32 index, nsAString & _retval); \
  NS_IMETHOD GetValue(PRUint32 index, nsAString & _retval); \
...
#define NS_FORWARD_NSISAXATTRIBUTES(_to) \
  NS_IMETHOD GetIndexFromName(const nsAString & uri, const nsAString & localName, PRInt32 *_retval) { return _to GetIndexFromName(uri, localName, _retval); } \
  NS_IMETHOD GetIndexFromQName(const nsAString & qName, PRInt32 *_retval) { return _to GetIndexFromQName(qName, _retval); } \
  NS_IMETHOD GetLength(PRInt32 *aLength) { return _to GetLength(aLength); } \
  NS_IMETHOD GetLocalName(PRUint32 index, nsAString & _retval) { return _to GetLocalName(index, _retval); } \
  NS_IMETHOD GetQName(PRUint32 index, nsAString & _retval) { return _to GetQName(index, _retval); } \
  NS_IMETHOD GetType(PRUint32 index, nsAString & _retval) { return _to GetType(index, _retval); } \
  ...
  NS_IMETHOD GetURI(PRUint32 index, nsAString & _retval) { return _to GetURI(index, _retval); } \
  NS_IMETHOD GetValue(PRUint32 index, nsAString & _retval) { return _to GetValue(index, _retval); } \
...
#define NS_FORWARD_SAFE_NSISAXATTRIBUTES(_to) \
  NS_IMETHOD GetIndexFromName(const nsAString & uri, const nsAString & localName, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIndexFromName(uri, localName, _retval); } \
  NS_IMETHOD GetIndexFromQName(const nsAString & qName, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIndexFromQName(qName, _retval); } \
  NS_IMETHOD GetLength(PRInt32 *aLength) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLength(aLength); } \
  NS_IMETHOD GetLocalName(PRUint32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLocalName(index, _retval); } \
  NS_IMETHOD GetQName(PRUint32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetQName(index, _retval); } \
  NS_IMETHOD GetType(PRUint32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetType(index, _retval); } \
  ...
  NS_IMETHOD GetURI(PRUint32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetURI(index, _retval); } \
  NS_IMETHOD GetValue(PRUint32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetValue(index, _retval); } \
