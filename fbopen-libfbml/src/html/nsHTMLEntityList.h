...
HTML_ENTITY(sbquo, 130)
HTML_ENTITY(fnof, 131)
HTML_ENTITY(bdquo, 132)
HTML_ENTITY(hellip, 133)
HTML_ENTITY(dagger, 134)
HTML_ENTITY(Dagger, 135)
HTML_ENTITY(circ, 136)
HTML_ENTITY(permil, 137)
HTML_ENTITY(Scaron, 138)
HTML_ENTITY(lsaquo, 139)
HTML_ENTITY(OElig, 140)
HTML_ENTITY(lsquo, 145)
HTML_ENTITY(rsquo, 146)
HTML_ENTITY(ldquo, 147)
HTML_ENTITY(rdquo, 148)
HTML_ENTITY(bull, 149)
HTML_ENTITY(ndash, 150)
HTML_ENTITY(mdash, 151)
HTML_ENTITY(tilde, 152)
HTML_ENTITY(trade, 153)
HTML_ENTITY(scaron, 154)
HTML_ENTITY(rsaquo, 155)
HTML_ENTITY(oelig, 156)
HTML_ENTITY(Yuml, 159)
