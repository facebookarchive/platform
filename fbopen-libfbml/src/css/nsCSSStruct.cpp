...
nsCSSFilter::nsCSSFilter(void)
{
  MOZ_COUNT_CTOR(nsCSSFilter);
}

nsCSSFilter::nsCSSFilter(const nsCSSFilter& aCopy)
  : mValue(aCopy.mValue)
{
  MOZ_COUNT_CTOR(nsCSSFilter);
}
