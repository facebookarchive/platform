...
<script type="text/javascript">
    function showFeed() {
      ...
      FB.Integration.showFeedDialog(<?php echo FEED_STORY_1;?>, template_data, [], '',
                                   function(){alert("You just saw the feed dialog.")});
    }
    ...
    FB_RequireFeatures(["Integration"], function() {
        ...
        // You can copy my receiver.html to your server and it will work fine.
